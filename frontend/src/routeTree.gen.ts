...
import { Route as LayoutSessionsAnalysisv2SessionIdImport } from './routes/_layout/sessions_.analysis_v2.$sessionId'
...
const LayoutSessionsRoute = LayoutSessionsImport.update({
  ...
  import('./routes/_layout/sessions.lazy').then((d) => d.Route),
)
...
const LayoutSessionsNewRoute = LayoutSessionsNewImport.update({
  ...
  import('./routes/_layout/sessions_.new.lazy').then((d) => d.Route),
)
...
const LayoutnosidebarSessionsRunSessionIdRoute =
  LayoutnosidebarSessionsRunSessionIdImport.update({
    ...
    import('./routes/_layout_no_sidebar/sessions_.run.$sessionId.lazy').then(
      (d) => d.Route,
    ),
  )

const LayoutSessionsAnalysisv2SessionIdRoute =
  LayoutSessionsAnalysisv2SessionIdImport.update({
    path: '/sessions/analysis_v2/$sessionId',
    getParentRoute: () => LayoutRoute,
  } as any).lazy(() =>
    import('./routes/_layout/sessions_.analysis_v2.$sessionId.lazy').then(
      (d) => d.Route,
    ),
  )
...
const LayoutSessionsAnalysisSessionIdRoute =
  LayoutSessionsAnalysisSessionIdImport.update({
    ...
    import('./routes/_layout/sessions_.analysis.$sessionId.lazy').then(
      (d) => d.Route,
    ),
  )
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_layout/sessions/analysis_v2/$sessionId': {
      preLoaderRoute: typeof LayoutSessionsAnalysisv2SessionIdImport
      parentRoute: typeof LayoutImport
    }
...
export const routeTree = rootRoute.addChildren([
  LayoutRoute.addChildren([
    ...
    LayoutSessionsAnalysisv2SessionIdRoute,
  ]),
